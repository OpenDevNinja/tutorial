...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-slate-50 p-8 rounded-2xl hover:shadow-lg transition-all duration-300 group border border-slate-200">
                {testimonial.isVideo && (
                  <div className="w-full h-48 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-xl mb-6 flex items-center justify-center relative overflow-hidden group-hover:shadow-md transition-shadow duration-300">
      ...
      {showVideoModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-3xl max-w-3xl w-full p-10 text-center shadow-2xl">
            ...
            <div className="w-full h-72 bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 rounded-2xl mb-8 flex items-center justify-center relative overflow-hidden shadow-lg">
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/20 to-transparent"></div>
              <div className="relative z-10 bg-white rounded-full p-6 shadow-xl hover:scale-110 transition-transform duration-300">
                <Play className="w-16 h-16 text-indigo-600" />
              </div>
            </div>

            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              Pour accéder à ma vidéo de présentation exclusive et découvrir ma méthode révolutionnaire,
